...
const testDescription = "it should successfully invoke a contract send for a valid contract with parameters provided";
export const InvokeSendContractWithArgs = ({ run, status }: TestCaseProps) => {
