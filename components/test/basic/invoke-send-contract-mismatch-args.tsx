...
const testDescription = "it should throw an error when send for a valid contract but incorrect parameters provided";
export const InvokeSendContractMismatchArgs = ({ run, status }: TestCaseProps) => {
    ...
    const runTest = async () => {
        ...
        await Assert.throwsAsync(async () => {
            await sdk.send(TEST_TOKEN_CONTRACT, "balance", args)
        });
