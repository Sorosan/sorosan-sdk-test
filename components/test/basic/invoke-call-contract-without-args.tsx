...
const testDescription = "it should successfully invoke a contract call for a valid contract without any parameters";
export const InvokeCallContractWithoutArgs = ({ run, status }: TestCaseProps) => {
    ...
    const runTest = async () => {
        ...
        try {
            ...
            // Act
            const actualTokenName: any = await sdk.call(TEST_TOKEN_CONTRACT, "name");
