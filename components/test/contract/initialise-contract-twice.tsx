...
const testDescription = "it should throw an error when using calling initialisation for a contract twice";
export const InitialiseContractTwice = ({ run, status }: TestCaseProps) => {
    ...
    const runTest = async () => {
        ...
        try {
            ...
            await Assert.throwsAsync(async () => {
                await sdk.contract.initialise(contractAddress, "initialize", args)
            });
        } catch (error: any) {
