...
const testDescription = "it should throw an error when public key is empty or invalid"
export const DeployContractEmptyPublicKey = ({ run, status }: TestCaseProps) => {
    ...
    const runTest = async () => {
        ...
        try {
            ...
            await Assert.throwsAsync(async () => {
                await sdk.contract.deploy(TEST_WASM, "");
            });            
        } catch (error: any) {
